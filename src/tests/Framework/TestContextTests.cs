...
using System;
using System.IO;
using TCLite.TestData.TestContextData;
    ...
    public class TestContextTests
    {
        ...
        public void TestCanAccessItsOwnFullName()
        {
            Assert.That(TestContext.CurrentContext.Test.FullName,
                Is.EqualTo($"{GetType().FullName}.TestCanAccessItsOwnFullName"));
        }
        ...
        public void TestCanAccessTestDirectory()
        {
            ...
            Assert.That(File.Exists(Path.Combine(testDirectory, "tclite.tests.dll")));
        }
#endif
