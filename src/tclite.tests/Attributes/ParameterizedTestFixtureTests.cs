...
namespace TCLite.Framework.Attributes
{
    ...
    public class ParameterizedTestFixtureNamingTests
    {
        ...
        {
            fixture = TestBuilder.MakeFixture(typeof(TCLite.TestData.ParameterizedTestFixture));
        }
        ...
        public void TopLevelSuiteIsNamedCorrectly()
        {
            ...
            Assert.That(fixture.FullName, Is.EqualTo("TCLite.TestData.ParameterizedTestFixture"));
        }
        ...
        public void FixtureInstancesAreNamedCorrectly()
        {
            ...
            Assert.That(fullnames, Is.EquivalentTo(new string[] {
                "TCLite.TestData.ParameterizedTestFixture(1)", "TCLite.TestData.ParameterizedTestFixture(2)" }));
#else
            Assert.That(names, Is.EqualTo(new string[] {
                "ParameterizedTestFixture(1)", "ParameterizedTestFixture(2)" }));
    ...
    public class ParameterizedTestFixtureTests
    {
        ...
        {
            Test fixture = TestBuilder.MakeFixture(typeof(TCLite.TestData.TestFixtureWithSingleCategory));
        ...
        {
            Test fixture = TestBuilder.MakeFixture(typeof(TCLite.TestData.TestFixtureWithMultipleCategories));
