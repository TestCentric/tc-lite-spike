...
namespace TCLite.Framework.Builders
{
	...
	public class NUnitTestFixtureBuilder : ISuiteBuilder
    {
		...
		public bool CanBuildFrom(Type type)
		{
            ...
            return Reflect.HasMethodWithAttribute(type, typeof(TCLite.Framework.TestAttribute)) ||
                   Reflect.HasMethodWithAttribute(type, typeof(TCLite.Framework.TestCaseAttribute)) ||
                   Reflect.HasMethodWithAttribute(type, typeof(TCLite.Framework.TestCaseSourceAttribute)) ||
                   Reflect.HasMethodWithAttribute(type, typeof(TCLite.Framework.TheoryAttribute));
		}
